...
This means that for a given country, no other country in Europe displays both a higher average net real wage and a lower price level.
- Which countries are the **most dominated**, i.e. have many other countries that simultaneously offer:
  ...
  - a lower price level?
For each country in my dataset, I calculate the number of other countries that simultaneously have a higher average net real wage and a lower cost of living. I then compile a list of the ten most dominated countries in my sample.

## Data

- **Source:** Wikipedia pages on:
  - Average net nominal wages by country
  - Average net real wages by country
- **Variables:**
...
The analysis is performed on a panel of European countries for which the two variables (net nominal and net real wage) can be obtained.
