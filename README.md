...
Conversely, low nominal wages for a given real wage imply a lower price level.
...
ln⁡(Price Level)ln(Price Level) on ln⁡(Net Nominal Wage)ln(Net Nominal Wage)
ln⁡(Price Level)ln(Price Level) on ln⁡(Net Real Wage)ln(Net Real Wage)
